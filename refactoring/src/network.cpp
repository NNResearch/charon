...
PyObject* pAttackInit;
PyThreadState* tstate; 
PyGILState_STATE gstate;

PyObject* create_attack_from_network(const Network& net) {
...
PyObject* Attack_For_Net(Network& net) {
    PyObject* pgdAttack;
    try {
        pgdAttack = create_attack_from_network(net); // this return an object to IntervalPGDAttack
